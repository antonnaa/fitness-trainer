...
export default function About() {
	return (
		<div className='min-h-screen bg-gray-50'>
			{/* Hero Section с фотографией */}
			<section className='relative bg-gradient-to-r from-gray-900 to-gray-700 text-white py-20'>
				<div className='container mx-auto px-6'>
					<div className='flex flex-col md:flex-row items-center gap-8 md:gap-12'>
						{/* Фотография */}
						<div className='shrink-0'>
							<div className='w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-orange-500 shadow-lg relative'>
								<Image src='/trainer-photo.jpg' alt='Антон — персональный тренер' fill className='object-cover' priority />
							</div>
						</div>
						...
						<div className='text-center md:text-left'>
							...
							<p className='text-lg md:text-xl text-gray-300'>Профессиональный тренер с опытом работы более 2 лет. Помогаю людям достигать их целей через научный подход к тренировкам и питанию.</p>
						</div>
					</div>
				</div>
			</section>
				...
				<div className='grid md:grid-cols-2 gap-12 items-center'>
					<div>
						...
						<div className='space-y-4 text-gray-700'>
							...
							<p>Я прошел курсы профессиональной переквалификации в &laquo;FPA — Ассоциация профессионалов фитнеса&raquo; по специальности &laquo;Персональный фитнес тренер&raquo;.</p>

					...
					<div className='flex flex-col md:flex-row items-center gap-8 md:gap-12'>
						...
						<div className='shrink-0'>
							<div className='w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-orange-500 shadow-lg relative'>
								<Image src='/trainer-photo.jpg' alt='Персональный тренер' fill className='object-cover' priority />
							</div>
						</div>
						...
						<div className='text-center md:text-left'>
							...
							<p className='text-lg md:text-xl text-gray-300'>Профессиональный тренер с опытом работы более [X] лет. Помогаю людям достигать их целей через научный подход к тренировкам и питанию.</p>
						</div>
					</div>
				</div>
			</section>
			...
			<section className='bg-white py-16'>
				<div className='container mx-auto px-6'>
					...
					<div className='grid md:grid-cols-3 gap-8'>
						{[
							{ stat: '200+', label: 'Довольных клиентов', icon: '👥' },
							{ stat: '500+', label: 'Проведенных тренировок', icon: '💪' },
							{ stat: '95%', label: 'Достигают цели за 3 месяца', icon: '🎯' },
						].map((item, idx) => (

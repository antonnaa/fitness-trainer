export default function Reviews() {
	const reviews = [
		...
		{
			name: 'Джаббаров Денис',
			goal: 'Набор мышечной массы',
			result: '+4 кг мышц за 3 месяцев',
			text: 'До начала занятий был очень худым, не мог набрать вес. Тренер составил грамотную программу тренировок и питания. Результат превзошел ожидания — набрал 4 кг качественной массы, стал увереннее в себе.',
			rating: 5,
			date: 'Декабрь 2025',
		},
		{
			name: 'Александрова Светлана',
